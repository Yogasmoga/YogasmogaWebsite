            ...
            foreach($customerlist as $customer)
            {
                ...
                if(!$this->isUnsubscribedFromMailchimp($email)) {
                    ...
                    if ($serverType == 'production')
                        ...
                        //$notification_log->setEmail_status($this->sendemail($customer['customer_name'], "fahim.khan@yogasmoga.com", $customer['bucks_expiring'], $notification_period, $bucks_expiration_date_string));
