...
class J2t_Rewardapi_Model_Stats_Api extends J2t_Rewardapi_Model_Api_Resource
{
    ...
    public function add($customerId, $points, $storeIds)
    {
        ...
        $data = array('points_current' => $points, 'customer_id' => $customerId, 'store_id' => $storeIds, 'order_id' => Rewardpoints_Model_Stats::TYPE_POINTS_ADMIN, 'date_start' => date("Y-m-d"));
    ...
    public function remove($customerId, $points, $storeIds)
    {
        ...
        $data = array('points_spent' => $points, 'customer_id' => $customerId, 'store_id' => $storeIds, 'order_id' => Rewardpoints_Model_Stats::TYPE_POINTS_ADMIN);
