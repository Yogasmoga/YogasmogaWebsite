    ...
    jQuery.fn.ClassyLoupe = function (a) {
        ...
        return this.each(function () {
            ...
            jQuery.browser.webkit && document.readyState != "complete" ? setTimeout(arguments.callee, 100) : (function () {
                ...
                p ? ($("#" + c).stop().fadeOut(a.loupe_toggle_time, a.loupe_toggle_easing), p = !1, a.apply_overlay && $("#" + t).stop().fadeOut(a.overlay_effect_time, a.overlay_effect_easing)) : ($("#" + c).stop().fadeIn(a.loupe_toggle_time, a.loupe_toggle_easing), p = !0, a.apply_overlay && $("#" + t).stop().fadeTo(a.overlay_effect_time, a.overlay_opacity, a.overlay_effect_easing), A());
