...
//        var price = _productcolorinfo[colorindex].sizes[i].substr(_productcolorinfo[colorindex].sizes[i].indexOf('|', _productcolorinfo[colorindex].sizes[i].indexOf('|') + 1) + 1);
    ...
    if (_productdisplaymode == 'popup') {
        ...
        for (i = 0; i < _productcolorinfo[colorindex].smallimages.length; i++) {
            smallimagehtml = smallimagehtml + "<td bigimageurl='" + _productcolorinfo[colorindex].bigimages[i][0] + "' zoomimageurl='" + _productcolorinfo[colorindex].zoomimages[i][0] + "'><img src='" + _productcolorinfo[colorindex].smallimages[i][0] + "' alt='" + _productcolorinfo[colorindex].smallimages[i][1] + "'  title='" + _productcolorinfo[colorindex].smallimages[i][2] + "' fahim-data='" + _productcolorinfo[colorindex].smallimages[i][3] + "' ></td>";
        }
    ...
    jQuery.ajax({
        ...
        success: function (result) {
            ...
            if (result.status == 'success') {
                ...
                jQuery("span.cartitemcount").html(result.count);jQuery("li#shop-bag-count span").html(result.count);
