...
class Ipinfo {
	 ...
	 * @return \Ipinfo\Host The Host object with all the info.
	 */
	 ...
	 * @return string|\Ipinfo\Host The value of the given field for the given ip.
	 ...
	 * @param string $field The field.
	 * @return string|\Ipinfo\Host The value of the given field for your own ip.
	 * This could returns an Host object if you call it with for the field
	 * \Ipinfo\Ipinfo::GEO.
	 */
	 ...
	 * @return Ambigous <\Ipinfo\Host, string> Returns an Host object if the request is
	...
	private function makeCurlRequest($address){
		...
		curl_close($curl);
		if($this->settings['debug']){
			echo "Responce json: " . var_dump($response) . "\n";
		}
