     ...
     <div class="author_post_read rangoli_press_banner">
        ...
        <div class="overlay-text">
            <div class="align_bottom">
                ...
                <div class="post_author">with <span class="press-name"><a href="<?php echo(types_render_field( "contributing-website-url", array( 'raw' => true) )); ?>">
...
<div class="post_content rangoli_press_content" style="display: block;">
