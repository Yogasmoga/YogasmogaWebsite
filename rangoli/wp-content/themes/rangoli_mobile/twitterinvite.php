...
?>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $(".message").height($(window).height()-176);
            $('span.page_name').html("CONNECT");
        ...
        function sendNow() {
            ...
            if(selected) {
                ...
                $.ajax({
                    url: "http://staging.yogasmoga.com/rangoli/wp-content/themes/rangoli/twt_send_direct_messages.php",
                    type: 'POST',
...
?>
    <div class="message">
        ...
        <div class="invite_sent_message">
            ...
            <p>Thank you for inviting more people to discover their color journey on RANGOLI. <br/> When
                your friends sign on & make a purchase at yogasmoga.com, you earn $2 SMOGI Bucks.
...
-->
    ...
    <style>
        ...
        .message, .message-display, .invite_sent_message, .row {
            float: left;
            width: 100%;
        }
        .friend {
        ...
        .send-invites {
            background: none repeat scroll 0 0 #ae8536;
            border: medium none;
            bottom: 0;
            color: #fff;
            font: 20px/58px freight-text-pro;
            height: 58px;
            left: 0;
            position: fixed;
            right: 0;
