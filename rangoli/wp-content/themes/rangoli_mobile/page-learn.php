...
//            $filter_length=();
    if ($filter_query) {
        ...
        <div class="author_post_read" style="background: <?php echo $color; ?>">
            ...
            <div class="share_post  <?php if($logged_in){echo 'user-color-shade-trans';} ?>">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                     width="44px" height="44px" viewBox="0 0 44 44" enable-background="new 0 0 44 44" xml:space="preserve">
<g>
    <g>
...
//                if(isset($current_category)) {
                    if (has_category("learn")) {
                        ...
                        if (isset($level) && count($level) > 0 && isset($duration) && count($duration) > 0 && isset($style) && count($style) > 0) {
                            ?>
                            <div class="basic_learn_page_info" >
                            ...
                            <div class="right">
                                ...
                                ?>
                                <div class="rating" rel="<?php echo $rating; ?>" post_id="<?php echo $post->ID; ?>">
