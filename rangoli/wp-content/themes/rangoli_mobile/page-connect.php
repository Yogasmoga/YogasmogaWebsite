...
?>
    ...
    <p <?php if(!is_user_logged_in()){echo "style='background:rgba(85,85,85,0.95);'";} else { echo "class='user-color-shade'";} ?> style="height: 50px;"><i class="link">http://rango.li/1JkCPWc</i> <span class="copy_link" data-clipboard-text="">Copy link</span></p>
    </div>
