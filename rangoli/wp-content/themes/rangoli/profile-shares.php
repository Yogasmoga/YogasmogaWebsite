<div class="row">
    ...
    if ($user_favs) {
        ...
        <div class="flexslider" id="author_shares">
            <ul class="slides" >
                <?php
...
<style>
    #author_shares.flexslider{
        overflow: visible;
    }
    #author_shares .flex-direction-nav {
        display: block;
        height: 24px;
        position: absolute;
        top: -37px;
    ...
    #author_shares .flex-direction-nav .flex-prev {
    ...
    #author_shares .flex-direction-nav .flex-next {
        background: url("<?php  echo get_site_url() ?>/wp-content/themes/rangoli/images/arrows-slider.png") repeat scroll 0 0 / 50px auto rgba(0, 0, 0, 0);
        height: 25px;
        right: 0;
    ...
    #author_shares .flex-control-nav{
        display:none;
    }
</style>
<script>
