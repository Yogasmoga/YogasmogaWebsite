...
<section class="third">
    <div class="row">
        <div class="two-three left double-width">
            ...
            <p class="post_link"><a class="ajax-load" href="<?php echo get_site_url(); ?>/read">Learn More</a></p>
        </div>
        ...
        <div class="one-three left">
            ...
            <div onclick="ajax_load_pages('<?php echo get_author_posts_url($author_id); ?>')" class="overlay-text">
                ...
                <p class="post_link"><a class="ajax-load" href="<?php echo get_author_posts_url($author_id); ?>">MEET
                        OUR SMOGIs</a></p>
...
<section class="fourth">
    <div class="row">
        ...
        <div class="one-three left">
            ...
            <p class="post_link"><a class="ajax-load" class="ajax-load" href="<?php echo get_site_url(); ?>/read">Read
                    More</a></p>
        </div>
        ...
        <div class="one-three left">
            ...
            <p class="post_link"><a class="ajax-load" class="ajax-load" href="<?php echo get_site_url(); ?>/learn">Learn
                    More</a></p>
