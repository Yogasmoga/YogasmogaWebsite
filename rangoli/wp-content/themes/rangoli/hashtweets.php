...
//                echo "<hr/>";
            ...
            ?>
            <div class="row one-three" <?php if ($media) { ?> style="background: url('<?php echo $ar_media_data['media_url'] ?>'); background-position: center center; position:absolute;top:0;left:0; width: 100%;height:100%;"        <?php } ?>
            ...
            <div class="overlay-text" onclick="window.open('http://twitter.com/yogasmoga','_blank')">
                ...
                if ($ar['text']) {
                    ...
                    <span class='fts-twitter-text'
                          onclick="window.open('http://twitter.com/yogasmoga/', '_blank')"
                        ><?php print $text ?></span>
                    <span class="twitter_author"><a target="_blank" href='http://twitter.com/yogasmoga'>YOGASMOGA</a></span>
                <?php
                }
                ?>
