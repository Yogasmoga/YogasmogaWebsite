...
<!-- Google Tag Manager -->
<noscript>
    <iframe src="//www.googletagmanager.com/ns.html?id=GTM-PGF5K4" height="0" width="0"
    ...
    <div class="header">
        <div class="header-left">
            <div class="header-left logo">
                <a class="logo menu-heading menu-heading1" href="/"><img
                        src="<?php echo get_site_url(); ?>/wp-content/themes/rangoli/images/ys_logo.png"></a>
            </div>
                    ...
                    <ul class="sub-menu menu-ovr second-list">
                        ...
                        <li><a href="/mens/bottoms"> Bottoms</a>
                            <ul>
                                ...
                                <li><a href="/mens/bottoms/pants">Pants</a></li>
                            </ul>
                        </li>
                ...
                <ul class="shipping-menu tr-menu">
                    ...
                    <li data-blockid="help-new">
                        ...
                        <ul style="left: -87px;" class="sub-menu l-align cms-header-link">
                            ...
                            <li data-blockid="shipping-returns"><a href="/help#shipping-returns">Shipping and
                                    Returns</a></li>
                    ...
                    <li><a href="#" id="welcome-name">My Account</a>
                        <ul style="left: -64px;" class="sub-menu l-align my-acnt">
                            ...
                            <li class="last login_logout_link"><a href="javascript:void(0);" id="signin">Sign In</a>
                            </li>
                        </ul>
                        <span>|</span>
                    </li>
                    <li onclick="window.location='/'"><span id="cart" class="open-cart" href="/">Shopping Bag (<span
                                class="cartitemcount"><?php echo get_cart_count(); ?></span>)</span></li>
            ...
            <div class="right-bottom-block">
                ...
                <div class="search-bar in-bl">
                    <form autocomplete="off" method="get" action="/catalogsearch/result/" id="search_frm">
                        <input type="text" data-watermark="Search" maxlength="200" vlogo menu-heading
                               menu-heading1alue="Search" name="q" id="search_input" class="watermark">
...
<div class="wp_page" id="page">
    <div class="menu-btn" style="<?php echo $style; ?>">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
             x="0px" y="0px" width="30px" height="40px" viewBox="0 -4 30 60" enable-background="new 0 -4 30 60"
             xml:space="preserve">
        <defs>
        </defs>
    ...
    <div class="color-game" onclick="window.location='<?php echo get_site_url(); ?>'"
         style="<?php echo $style; ?>; cursor:pointer;">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
             x="0px" y="0px" width="30px" height="40px" viewBox="-0.339 -1 30 60"
             enable-background="new -0.339 -1 30 60" xml:space="preserve">
        <defs>
        </defs>
            <polygon fill=" #555" stroke=" #555" stroke-width="2" stroke-miterlimit="10"
                     points="1.661,1 28.112,1 14.887,27.01 "/>
            <polygon fill="none" stroke=" #555" stroke-width="2" stroke-miterlimit="10"
                     points="1.661,30 14.887,54.98 27.661,30 "/>
        </svg>
    </div>
        ...
        <div class="menu-content white">
            ...
            <ul class="profile-links">
                ...
                <li><a class="home_link" href="<?php echo get_home_url() ?>/">
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                             x="0px" y="0px" width="34px" height="30px" viewBox="-0.5 -0.293 34 30"
                             enable-background="new -0.5 -0.293 34 30" xml:space="preserve">
                    <defs>
                    </defs>
                            <path fill="none" stroke="#000000" stroke-miterlimit="10"
                                  d="M23.539,12.227v14.886H0.5V12.227l11.52-11.52L23.539,12.227z   M15.06,18.72h-6.08v8.393h6.08V18.72z"/>
                    </svg>

                        <!--                    <img src="-->
                        <?php //bloginfo('template_directory')?><!--/images/home.png" /> -->
            ...
            <ul class="shop-yogasmoga">
                <li style="position: relative">
                    <a href="/"><img class="right"
                                     src="<?php echo get_site_url() ?>/wp-content/themes/rangoli/images/ys-store.png"/></a>
                    <a href="/" style="position: absolute; top:0 ; left:0; "><img class="right"
                                                                                  src="<?php echo get_site_url() ?>/wp-content/themes/rangoli/images/ys_store_hover.png"/></a>

                </li>
            </ul>
            <ul class="about-rangoli">
                <li style="padding-right: 5px; position: relative">
                    <a href="<?php echo get_site_url() ?>/about"><img class="right"
                                                                      src="<?php echo get_site_url() ?>/wp-content/themes/rangoli/images/about.png"/>
                    </a>
                    <a href="<?php echo get_site_url() ?>/about" style="position: absolute; top:0 ; left:0; "><img
                            class="right"
                            src="<?php echo get_site_url() ?>/wp-content/themes/rangoli/images/ys_rangoli_hover.png"/>
                    </a>
