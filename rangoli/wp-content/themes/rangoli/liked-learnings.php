<div class="row">
    ...
    if ($user_favs) {
        foreach ($user_favs as $user_fav) {
            ...
            if (isset($_REQUEST['topic'])) {
                ...
                $filter_query = has_category($filter_category_name, $user_fav);
    ...
    if ($user_favs) {
    ?>
    <div class="flexslider liked_learns" id="liked_learns">
        <ul class="slides">
            <?php
            $x = 0;
            foreach ($user_favs as $user_fav) {
...
<style>
    ...
    #liked_learns .flex-direction-nav {
        display: block;
        height: 24px;
        position: absolute;
        top: -37px;
    ...
    #liked_learns .flex-direction-nav .flex-prev {
    ...
    #liked_learns .flex-direction-nav .flex-next {
        background: url("<?php  echo get_site_url() ?>/wp-content/themes/rangoli/images/arrows-slider.png") repeat scroll 0 0 / 50px auto rgba(0, 0, 0, 0);
        height: 17px;
        right: 0;
