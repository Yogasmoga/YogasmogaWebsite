            ...
            <div class="sharing_icons">
                <ul>
                    ...
                    <li>
						...
						<a target="_blank" rel="<?php echo $post->ID; ?>" user="<?php echo get_current_user_id();  ?>" href="https://www.facebook.com/sharer/sharer.php?app_id=1681200982154249&u=<?php echo $b_pl; ?>">
