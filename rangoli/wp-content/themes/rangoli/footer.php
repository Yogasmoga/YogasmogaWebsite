...
<div id="signin_popup">
    ...
    <div class="signin-block mage" style="background: url('<?php echo get_site_url()."/wp-content/themes/rangoli/images/red_popup.png" ?>') no-repeat;">
        ...
        <div class="form">
            ...
            <?php /* ?><p class="opensignin" onclick="$('.login_logout_link').click();">I&rsquo;m already signed up.</p><?php */ ?>
            <p class="opensignin" onclick="jQuery('.close_signin_popup').click()">I&rsquo;m already signed up.</p>
