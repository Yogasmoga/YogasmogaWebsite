                ...
                <div class="back">
                    ...
                    <div id="ap_signin_popup">
						...
						<div id="thank_you_box" class="signup-thankyou">
							...
							<small>We've also emailed it to you in case you forget.</small>
							<p class="mc-shoplinks">
								<a href="/women"><img src="<?php echo get_template_directory_uri().'images/mc-shopwomen.jpg' ?>" alt=""/></a>
								<a href="/men"><img src="<?php echo get_template_directory_uri().'images/mc-shopmen.jpg'?>" alt=""/></a>
							</p>
