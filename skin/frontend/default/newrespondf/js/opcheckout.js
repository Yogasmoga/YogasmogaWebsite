...
Checkout.prototype = {
    ...
    reloadProgressBlock: function(){
         var updater = new Ajax.Updater('onepage-progress-content', this.progressUrl, {method: 'get', onFailure: this.ajaxFailure.bind(this)});
    },
    ...
    setMethod: function(){
        ...
        jQuery(document).find('p.selected_method').click(function () {
            alert();
            jQuery(document).find('.options_methods').slideToggle();
        });
        jQuery('.options_methods .method').click(function(){
            alert();
