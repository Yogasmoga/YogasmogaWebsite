            ...
            //Google Standard attribute.added by fahim.
                ...
                if (isset($_gallery)) {
                    ...
                    foreach ($_gallery as $_image) {
                        ...
                        $image_url = (string)Mage::helper('catalog/image')->init($configurableProduct, 'thumbnail', $_image->getFile())->constrainOnly(TRUE)->keepAspectRatio(TRUE)->keepFrame(FALSE)->resize(600, 600)->setQuality(91);
                        break;
                    }
                }
