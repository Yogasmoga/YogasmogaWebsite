            ...
            foreach ($customerlist as $customer) {
                ...
                if (!$this->isUnsubscribed($email)) {
                    ...
                    if ($serverType == 'production')
                        ...
                        //$notification_log->setEmail_status($this->sendemail($customer['customer_name'], "ankit@yogasmoga.com", $customer['bucks_expiring'], $notification_period, $bucks_expiration_date_string));
