...
class Ysindia_Events_Block_Adminhtml_Events_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if( Mage::registry('events_data') && Mage::registry('events_data')->getId() ) {
            return Mage::helper('events')->__("Edit Event '%s'", $this->htmlEscape(Mage::registry('events_data')->getTitle()));
        } else {
