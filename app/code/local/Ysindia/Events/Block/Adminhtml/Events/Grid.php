...
class Ysindia_Events_Block_Adminhtml_Events_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
	  ...
	  $this->addColumn('start_at_time', array(
          'header'    => Mage::helper('events')->__('time'),
          'align'     =>'left',
          'index'     => 'start_at_time',
      ));
	  $this->addColumn('function', array(
          'header'    => Mage::helper('events')->__('Instructor'),
          'align'     =>'left',
          'index'     => 'function',
      ));
/*	  
