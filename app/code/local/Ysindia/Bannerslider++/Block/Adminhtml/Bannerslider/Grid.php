...
class Ysindia_Bannerslider_Block_Adminhtml_Bannerslider_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('filename', array(
          ...
          'align'     =>'center',
          'index'     => 'filename',
          'renderer'  => 'Ysindia_Bannerslider_Block_Adminhtml_Renderer_Image'
      ));
      $this->addColumn('link1', array(
          'header'    => Mage::helper('bannerslider')->__('link1'),
          'align'     =>'left',
          'index'     => 'link1',
      ));
      $this->addColumn('link2', array(
          'header'    => Mage::helper('bannerslider')->__('link2'),
          'align'     =>'left',
          'index'     => 'link2',
      ));
      $this->addColumn('text', array(
          'header'    => Mage::helper('bannerslider')->__('text'),
          'align'     =>'left',
          'index'     => 'text',
      ));
