...
class Mage_Wishlist_IndexController extends Mage_Wishlist_Controller_Abstract
{
    ...
    public function addmobileAction()
    {
        ...
        try {
			...
			echo Mage::helper('core/url')->getHomeUrl()."wishlist/index/removemobile/item/".$wishid;
    ...
    public function removemobileAction()
    {
		...
		echo Mage::helper('core/url')->getHomeUrl()."wishlist/index/addmobile/product/".$productId;
		//exit;
        } catch (Mage_Core_Exception $e) {
