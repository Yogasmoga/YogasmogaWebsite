...
//        $filename = $path . $filename;
        ...
        $target_file = Mage::getBaseDir() . "\\temp\\" . basename($_FILES["file"]["name"]);
    ...
    function readConfigurable($filename){
        ...
        $includePath = Mage::getBaseDir(). "/lib/PhpExcel/Reader";
